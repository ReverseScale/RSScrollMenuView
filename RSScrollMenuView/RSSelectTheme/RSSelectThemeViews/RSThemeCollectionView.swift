...
let reuseIdentifier = "RSThemeCollectionViewCell"
let headerReuseIdentifier = "RSHeaderCollectionReusableView"
let firstSectionheaderReuseIdentifier = "RSFirstHeaderCollectionReusableView"

class RSThemeCollectionView: UICollectionView, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    /// 配置当前CollectionView
    private func config() {
        self.register(RSThemeCollectionViewCell.classForCoder(), forCellWithReuseIdentifier: reuseIdentifier)
        self.register(RSHeaderCollectionReusableView.classForCoder(), forSupplementaryViewOfKind: UICollectionElementKindSectionHeader, withReuseIdentifier: headerReuseIdentifier)
        self.register(RSFirstHeaderCollectionReusableView.classForCoder(), forSupplementaryViewOfKind: UICollectionElementKindSectionHeader, withReuseIdentifier: firstSectionheaderReuseIdentifier)
